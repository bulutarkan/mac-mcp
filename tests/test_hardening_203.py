...
class RiskAndScopeTests(unittest.TestCase):
    def test_registry_covers_current_95_tool_surface(self) -> None:
        self.assertEqual(95, len(RISK_REGISTRY))
        for required in ("run_command", "browser_observe", "browser_do", "computer_plan", "tool_discover", "tool_invoke", "spawn_agent", "mac_snapshot", "mac_act", "artifact_pipeline", "context_handoff", "browser_upload_artifact", "read_file", "lesson_search", "lesson_record", "lesson_feedback", "lesson_consolidate"):
