...
- Added a public regression-backed security assurance matrix for `SEC-FS-001`, `SEC-NET-001`, `SEC-AUTHZ-001`, `SEC-UPD-001`, and `SEC-TXN-001`; CI now rejects stale control/test references, orphan assurance tags, missing release-note linkage, and secret-like/private-path content in the public matrix.
